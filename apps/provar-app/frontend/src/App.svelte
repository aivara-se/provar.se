...
>
  <div
    class="absolute top-0 right-0 left-0 z-[5] h-[56px]"
  ...
  {:else}
    ...
    {#if !applicationStore.isRightSidebarOpen}
      <button
        ...
        class="absolute bottom-3 right-3 z-30 flex h-6 w-6 cursor-pointer items-center justify-center text-zinc-500 transition-colors duration-200 hover:text-zinc-200 focus:outline-none"
